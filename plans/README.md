...
Planning and design artifacts for Special Circumstances, kept here **while under active review** (each arrives as its own pull request). These are *plans for what we're going to build* — deliberately separated from the repo's "real" documentation (`README.md`, the per-plugin READMEs).
