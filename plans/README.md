...
- **`historical/mutation-audit.md`** — the retired mutation-testing programme: what two full sweeps measured, why a survivor did not mean what it read as, and the operator call that ended it. Kept for §0's evidence and for the one finding it produced ([#797](https://github.com/ctoforaday/special-circumstances/issues/797)).
