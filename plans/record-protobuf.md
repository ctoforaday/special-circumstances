...
### II.2 Wire format: textproto, canonicalized — BUILT
...
and chosen for stability (§IV.5), not layout.
...
Written before implementing; re-run on every PR including markdown-only ones.
