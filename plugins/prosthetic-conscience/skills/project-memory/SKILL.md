...
- AFTER a context compaction or session restart, YOU MUST read `AGENTS.md` and `task.md` FIRST and reconcile them against whatever you believe — the artifacts are the truth, your memory is the cache.
