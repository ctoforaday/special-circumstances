...
- BEFORE re-auditing, YOU MUST first confirm each prior gap's fix; a fresh instance of a class already named still FAILs — filed under the prior gap as a missed sweep, not as a new class.
