// node --test — the mjs READERS of the record layer: setup skeleton + mirror
// purge, scorecards, and capture's record-join / attestation audits. (The old
// hand-vs-shadow parity check retired with record-parity-check.mjs — seats no
// longer hand-write ledgers, so there is no hand artifact to compare.)
//
