// Command feov-subagentstop is the SubagentStop hook backend. It records one end of a
...
func main() {
	os.Exit(hookcmd.Run("feov-subagentstop", "SubagentStop", sittinghook.Stop, os.Stdin, os.Stdout))
}
