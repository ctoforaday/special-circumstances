...
// revision: the epoch-record event (W1.7), and the last thing blue does in a sitting.
//
...
// section nor a CHANGELOG entry: a lens misjudged the epoch state from the
...
type revisionResult struct {
	...
	// sitting closes. Empty on a clean epoch; a list is a debt blue can still discharge.
