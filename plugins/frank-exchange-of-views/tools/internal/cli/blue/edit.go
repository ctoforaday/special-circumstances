...
func newEdit() *cobra.Command {
	...
	flags.Text(c, flags.Quote, flags.DescQuote+". It is matched ACROSS the invisible anchor layer, and rejected if it contains a finding-marker or a citation anchor")
