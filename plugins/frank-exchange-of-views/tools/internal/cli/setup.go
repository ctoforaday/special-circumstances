...
func newSetup() *cobra.Command {
	...
	f.StringArrayVar(&lensAreas, flags.LensArea, nil, "a red lens area this run dispatches (repeatable; default every area — narrow it only with a reason) — the cast is written from these")
