...
func TestASeatWhoseIdentityNeverArrivedIsToldWhatToDo(t *testing.T) {
	h := registerResult{SeatID: "red-lens-evidence", IdentityAbsent: true}.Human()
	for _, want := range []string{
		"registered red-lens-evidence",
...
func TestASeatSeesThatTheHookIsMissingFromTheWholeRun(t *testing.T) {
	h := registerResult{SeatID: "red-lens-evidence", IdentityAbsent: true, RunVia: "inferred", HookAbsent: true}.Human()
	for _, want := range []string{
...
func TestAMissingIdentityAloneDoesNotAccuseTheHook(t *testing.T) {
	h := registerResult{SeatID: "red-lens-evidence", IdentityAbsent: true, RunVia: "flag"}.Human()
