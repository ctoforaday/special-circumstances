...
var RequiredFields = map[string][]string{
	...
	// volume. The three fields here are what makes the row mean something — WHICH citation
	// (or an explicit --independent), WHAT the source did for the claim, and the reading behind
	// that verdict.
	"verify": {"claim", "outcome", "text"},
}
