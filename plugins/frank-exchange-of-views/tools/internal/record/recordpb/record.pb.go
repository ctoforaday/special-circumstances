...
const file_record_proto_rawDesc = "" +
	...
	"\x10SCHEMA_VERSION_1\x10\x01\x1aa\x8a\xb5\x18]the protobuf record: one event stream, one row per act, schema derived from these descriptors*\xce\x19\n" +
	"\tEventType\x12\x1a\n" +
...
var file_record_proto_goTypes = []any{
	...
	(*DocketMotion)(nil),                  // 51: feov.record.v1.DocketMotion
	(*DocketRuling)(nil),                  // 52: feov.record.v1.DocketRuling
...
var file_record_proto_depIdxs = []int32{
	...
	42, // 26: feov.record.v1.Event.blue_edit:type_name -> feov.record.v1.BlueEdit
	43, // 27: feov.record.v1.Event.revision:type_name -> feov.record.v1.Revision
	44, // 28: feov.record.v1.Event.retire:type_name -> feov.record.v1.Retire
	45, // 29: feov.record.v1.Event.manifest_row:type_name -> feov.record.v1.ManifestRow
	46, // 30: feov.record.v1.Event.friction:type_name -> feov.record.v1.Friction
	47, // 31: feov.record.v1.Event.friction_none:type_name -> feov.record.v1.FrictionNone
	...
	23, // 34: feov.record.v1.TelemetryLine.new_mint:type_name -> feov.record.v1.NewMint
	25, // 35: feov.record.v1.TelemetryLine.repair_regression:type_name -> feov.record.v1.RepairRegression
	26, // 36: feov.record.v1.TelemetryLine.edge_deltas:type_name -> feov.record.v1.EdgeDeltas
	24, // 37: feov.record.v1.NewMint.by_severity:type_name -> feov.record.v1.SeverityTally
	63, // 38: feov.record.v1.NewMint.by_class:type_name -> feov.record.v1.NewMint.ByClassEntry
	...
	6,  // 45: feov.record.v1.Close.closure_class:type_name -> feov.record.v1.Disposition
	...
	49, // 59: feov.record.v1.Motion.grade:type_name -> feov.record.v1.GradeMotion
	50, // 60: feov.record.v1.Motion.petition:type_name -> feov.record.v1.PetitionMotion
	53, // 61: feov.record.v1.Motion.direction:type_name -> feov.record.v1.DirectionMotion
	51, // 62: feov.record.v1.Motion.docket:type_name -> feov.record.v1.DocketMotion
	...
	6,  // 66: feov.record.v1.DocketRuling.disposition:type_name -> feov.record.v1.Disposition
	...
	52, // 71: feov.record.v1.MotionRule.docket:type_name -> feov.record.v1.DocketRuling
