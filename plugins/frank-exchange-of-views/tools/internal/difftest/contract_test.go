...
func TestGoldenErrorCatalogue(t *testing.T) {
	...
	cases := []struct {
		...
		{"class-new missing definition", []string{"merge", "mint", "--class", "novel", "--class-new", "--check-kind", "document", "--check", "x", "--problem", "p"}},
		{"class-new unknown neighbor", []string{"merge", "mint", "--class", "novel", "--class-new", "--definition", "d", "--neighbor", "nope", "--distinguisher", "q", "--check-kind", "document", "--check", "x", "--problem", "p"}},
