	...
	return []scenario{
		...
		},
		{
			...
			cmds: []cmd{
				...
				base("merge", "mint", "--run", "{RUN}", "--seat-id", "red-merge-r1", "--class", "attestation-inflation", "--class-new", "--check-kind", "document", "--check", "x", "--problem", "p"),
				base("merge", "mint", "--run", "{RUN}", "--seat-id", "red-merge-r1", "--class", "attestation-inflation", "--class-new",
