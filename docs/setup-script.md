...
| Path | Result |
|---|---|
| Cold, empty cache | exit 0, ~30s, every plugin's hook binaries built — one per directory under `plugins/*/tools/cmd/`, 18 at the time of writing — and `sc-doctor` verdict DEGRADED |
